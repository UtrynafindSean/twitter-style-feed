            ...
            <article className="post" key={post.id}>
              ...
              <div className="post-content">
                ...
                <div className="post-actions">
                  ...
                  <button onClick={() => handleRepost(post.id)} aria-label="Repost">
                  ...
                  <button onClick={() => handleBookmark(post.id)} aria-label="Bookmark">
        ...
        prev.map((post) =>
          String(post.id) === String(postId)
            ? {
                ...
                likeCount: Number(returnedPost?.likeCount ?? data.likeCount ?? 0),
                reposted: Boolean(returnedPost?.reposted ?? post.reposted),
                repostCount: Number(returnedPost?.repostCount ?? post.repostCount ?? 0),
                bookmarked: Boolean(returnedPost?.bookmarked ?? post.bookmarked),
              }
            : post,
        ),
      );
        ...
        prev.map((post) =>
          String(post.id) === String(postId)
            ? {
                ...
                likeCount: Number(returnedPost?.likeCount ?? post.likeCount ?? 0),
                reposted: Boolean(returnedPost?.reposted ?? data.reposted),
                repostCount: Number(returnedPost?.repostCount ?? data.repostCount ?? 0),
                bookmarked: Boolean(returnedPost?.bookmarked ?? post.bookmarked),
              }
            : post,
        ),
        ...
        prev.map((post) =>
          String(post.id) === String(postId)
            ? {
                ...
                reposted: Boolean(returnedPost?.reposted ?? post.reposted),
                repostCount: Number(returnedPost?.repostCount ?? post.repostCount ?? 0),
                bookmarked: Boolean(returnedPost?.bookmarked ?? data.bookmarked),
              }
            : post,
        ),
      );
      ...
      <div className="notifications-page">
        ...
        {notifications.length === 0 ? (
          <div className="empty-notifications">
            <div className="empty-notifications-icon"><Icon name="notifications" size={30} /></div>
            ...
            {notifications.map((notification) => (
              ...
              >
                <div className="notification-icon">
                  {notification.type === "like" && <Icon name="heart" size={18} />}
                  {notification.type === "repost" && <Icon name="repost" size={18} />}
                  {notification.type === "comment" && <Icon name="comment" size={18} />}
                  {notification.type === "follow" && <Icon name="profile" size={18} />}
                  {notification.type === "activity" && <Icon name="notifications" size={18} />}
                </div>
          ...
          <div className="chat-panel">
            {!activeUser ? (
              <div className="empty-chat">
                <div className="empty-chat-icon"><Icon name="messages" size={34} /></div>
      ...
      <div className="bookmarks-page">
        ...
        {bookmarkedPosts.length === 0 ? (
          <div className="empty-bookmarks">
            <div className="empty-bookmarks-icon"><Icon name="bookmark" size={30} /></div>
                  ...
                  <article className="post" key={post.id}>
                    ...
                    <div className="post-content">
                      ...
                      <div className="post-actions">
                        ...
                        <button onClick={() => handleBookmark(post.id)} aria-label="Bookmark"><Icon name="bookmark" size={18} /></button>
                      </div>
                    </div>
                  </article>
                ))
                ...
                myLikedPosts.map((post) => (
                  <article className="post" key={post.id}>
                    ...
                    <div className="post-content">
                      ...
                      <div className="post-actions">
                        <button aria-label="Comments"><Icon name="comment" size={18} /><span>{(comments[post.id] || []).length}</span></button>

                        <button aria-label="Repost"><Icon name="repost" size={18} /><span>{post.repostCount}</span></button>

                        <button onClick={() => handleLike(post.id)} aria-label="Like"><Icon name="heart" size={18} /><span>{post.likeCount}</span></button>
